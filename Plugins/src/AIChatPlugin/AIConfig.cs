...
public class Configuration
{
    ...
    // Corrected path to TShockAPI.TShock.SavePath
    public static readonly string FilePath = Path.Combine(TShockAPI.TShock.SavePath, "AIChatPlusin.json");
    ...
    public static void LoadConfig()
    {
        ...
        else
        {
            ...
            {
                // Corrected path to TShockAPI.TShock.Log and TShockAPI.Localization
                TShockAPI.TShock.Log.Error(TShockAPI.Localization.GetString($"[AIChatPlugin] 加载配置时发生错误：{ex.Message}"));
            }
        }
    }
    #endregion
