...
public class Configuration
{
    ...
    public static void LoadConfig()
    {
        ...
        else
        {
            ...
            {
                // Corrected: Use the Instance to call the GetString method.
                TShock.Log.ConsoleError(string.Format(AIChatPlugin.Instance.GetString("[AIChatPlugin] 加载配置时发生错误：{0}"), ex.Message));
            }
        }
    }
    #endregion
